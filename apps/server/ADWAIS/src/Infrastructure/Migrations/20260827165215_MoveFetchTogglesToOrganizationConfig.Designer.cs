...
namespace Adwais.Infrastructure.Migrations
{
    ...
    [Migration("20260827165215_MoveFetchTogglesToOrganizationConfig")]
    partial class MoveFetchTogglesToOrganizationConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Adwais.Domain.Entities.UserAccess", b =>
                {
                    ...
                    b.ToTable("user_access", null, t =>
                        {
                            t.HasCheckConstraint("ck_user_access_role", "\"role\" IN ('Admin', 'Viewer', 'Employee', 'TenantViewer')");
                        });
                });
