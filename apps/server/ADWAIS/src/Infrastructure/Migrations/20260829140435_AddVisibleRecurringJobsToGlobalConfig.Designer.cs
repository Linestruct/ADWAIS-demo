...
namespace Adwais.Infrastructure.Migrations
{
    ...
    [Migration("20260829140435_AddVisibleRecurringJobsToGlobalConfig")]
    partial class AddVisibleRecurringJobsToGlobalConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Adwais.Domain.Entities.GlobalConfig", b =>
                {
                    ...
                    b.Property<string>("VisibleRecurringJobsCsv")
                        ...
                        .HasDefaultValueSql("'refresh-financial-materialized-views,refresh-monitoring-materialized-views,refresh-stale-materialized-views,system-event-cleanup,sync-intranet-calendars'");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            VisibleRecurringJobsCsv = "refresh-financial-materialized-views,refresh-monitoring-materialized-views,refresh-stale-materialized-views,system-event-cleanup,sync-intranet-calendars"
                        });
                });
            ...
            modelBuilder.Entity("Adwais.Domain.Entities.SystemEvent", b =>
                {
                    ...
                    b.HasIndex("OrganizationId")
                        .HasDatabaseName("ix_system_event_organization_id");
