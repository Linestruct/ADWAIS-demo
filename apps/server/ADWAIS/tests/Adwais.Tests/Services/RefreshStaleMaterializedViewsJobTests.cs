...
public class RefreshStaleMaterializedViewsJobTests
{
    private sealed class TestableRefreshStaleMaterializedViewsJob(
        IDbContextFactory<AnalyticsDbContext> dbContextFactory,
        IViewRefreshTracker tracker) : RefreshStaleMaterializedViewsJob(dbContextFactory, tracker)
    {
    ...
    private static (TestableRefreshStaleMaterializedViewsJob Job, AnalyticsDbContext DbContext) CreateJob()
    {
        ...
        var job = new TestableRefreshStaleMaterializedViewsJob(factoryMock.Object, tracker);
