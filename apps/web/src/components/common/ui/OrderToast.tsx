...
export function OrderToast({ order, t, faviconUrl, displayValue }: OrderToastProps) {
  ...
  return (
    <div 
      className="w-[calc(100vw-2rem)] lg:w-[480px] bg-primary-container rounded-xl lg:rounded-2xl p-3.5 lg:p-6 m3-elevation-2 flex items-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-300"
